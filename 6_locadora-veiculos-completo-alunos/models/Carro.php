 ...
 * Implementa a interface Locavel definida em Veículo.php
 */
...
class Carro extends Veiculo implements Locavel {
    ...
    /** 
     * M´etodo para devolver o carro à locadora
     * 
     * @return string Mensagem de resultado da operação
     */
     public function devolver(): string {
        ...
        return "Carro '{$this->modelo}^' já esta na locadora.";
     }
